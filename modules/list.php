...
$result = $conn->query("SELECT m.id, m.code, m.intitule, e.nom AS enseignant 
                        FROM module m 
...
<body>
  ...
  <a href="add.php" class="btn-ajout">+ Ajouter un module</a>
    ...
    <?php while($row = $result->fetch_assoc()) { ?>
      <tr>
        ...
        <td>
          ...
          <a href="delete.php?id=<?= $row['id'] ?>" onclick="return confirm('Supprimer ce module ?')">Supprimer</a>
        </td>
      </tr>
    <?php } ?>
  </table>
